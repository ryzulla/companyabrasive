...
<div class="max-w-xl">
    ...
    <div class="bg-white rounded-xl border border-slate-100 p-6">
        ...
        <form method="POST" action="{{ route('admin.clients.store') }}" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                <label class="block text-sm font-medium text-slate-700 mb-1.5">Logo Perusahaan <span class="text-red-500">*</span></label>
                <input type="file" name="logo" accept="image/*" required id="logoInput"
                ...
                <p class="text-xs text-slate-400 mt-1">Format: JPG, PNG, WebP. Maks 2MB. Disarankan rasio 16:9 atau kotak (max 400×200px).</p>
            ...
            <div>
                ...
                <input type="number" name="order" value="{{ old('order', 0) }}"
                       class="w-full px-3.5 py-2.5 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                       placeholder="0">
                <p class="text-xs text-slate-400 mt-1">Angka lebih kecil tampil lebih dahulu.</p>
            </div>
